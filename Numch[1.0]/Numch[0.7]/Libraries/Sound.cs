...
namespace Numch
{
    ...
    public class Sound : WaveStream
    {
        ...
        public static void PlaySound(String soundType)
        {
            ...
            {
                case "Click":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\ButtonClick.wav";
                    break;
                case "Back1":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\ButtonBack1.wav";
                    break;
                case "Back2":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\ButtonBack2.wav";
                    break;
                case "Coundown":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\Countdown.wav";
                    break;
                case "Exit":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\Exit.wav";
                    break;
                case "Play":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\Play.wav";
                    break;
                case "Play2":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\Play2.wav";
                    break;
                case "Lose":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\Lose.wav";
                    break;
                case "Win":
                    soundSource = @"C:\Users\meets_000\Google Drive\Uni Stuff\ACSC299\Group Project ACSC299\Audio\Fx\Win.wav";
                    break;
                default:
                    break;
            }
